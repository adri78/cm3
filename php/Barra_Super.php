...
<div id="navbar" class="navbar navbar-default ace-save-state">
    <div class="navbar-container ace-save-state" id="navbar-container">
        ...
        <ul class="nav navbar-nav  in">
            ...
            <li><a href="index.php"> Reparación </a></li>
            <li><a href="index.php" class="active"> Ventas </a></li>
            <li><a href="NC.php"> Señas </a></li>
            <li><a href="Garantias.php"> Cambios/Garantias </a></li>
            <li class=""><a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"> Informes <i class="fa fa-caret-down"></i></a>
                <ul class="dropdown-menu dropdown-messages">
            ...
            <li><a class="dropdown-toggle" data-toggle="dropdown" href="#"> Compras <i class="fa fa-caret-down"></i></a>
                <ul class="dropdown-menu dropdown-messages">
                    <li><a href="compras.php"> Telefonos </a></li>
                    <li><a href="repuestos.php"> Repuestos</a></li>
                    <li><a href="Tabla_Repuestos.php">Ficha Repuestos</a></li>
                </ul>
            </li>
        </ul>
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span class="user-info">
									<small><?php echo $User_Real ; ?></small>
                            <?php echo $Tipo_Nivel ; ?>
								</span>
